...
pagination = function pagination(options) {
    ...
    if (!_.isNull(this.pagination.next) && !_.isNumber(this.pagination.next) || !_.isNull(this.pagination.prev) && !_.isNumber(this.pagination.prev)) {
        return logAndThrowError('warnings.helpers.pagination.nextPrevValuesMustBeNumeric');
    }
