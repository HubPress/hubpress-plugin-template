...
function getPostSchema(metaData, data) {
    var description = metaData.metaDescription ? escapeExpression(metaData.metaDescription) : metaData.excerpt ? escapeExpression(metaData.excerpt) : null,
        schema;
    ...
    schema = {
        ...
        author: {
            ...
            description: data.post.author.bio ? escapeExpression(data.post.author.bio) : null
        },
        ...
        keywords: metaData.keywords && metaData.keywords.length > 0 ? metaData.keywords.join(', ') : null,
...
function getHomeSchema(metaData) {
    var schema = {
        ...
        url: metaData.url,
        image: metaData.coverImage,
        description: metaData.metaDescription ? escapeExpression(metaData.metaDescription) : null
    };
    return trimSchema(schema);
}
