...
var Builder = function () {
  function Builder() {
    ...
    _helpers2.default.loadCoreHelpers();
  }
  ...
  _createClass(Builder, [{
    ...
    key: 'isTemplateAvailable',
    value: function isTemplateAvailable(template) {
